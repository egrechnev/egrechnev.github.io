...
$mail->Username = '1taxopark@mail.ru'; // Ваш логин от почты с которой будут отправляться письма
$mail->Password = '555t000'; // Ваш пароль от почты с которой будут отправляться письма
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465; // TCP port to connect to / этот порт может отличаться у других провайдеров

$mail->setFrom('1taxopark@mail.ru'); // от кого будет уходить письмо?
$mail->addAddress('1taxopark@mail.ru');     // Кому будет уходить письмо
...
$mail->Subject = 'Заявка на заключение договора от ' .$n1a2m3e;
$mail->Body    = $content;
