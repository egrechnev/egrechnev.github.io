...
!function(a) {
    ...
    t.prototype = {
        ...
        open: function(c) {
            ...
            y("BuildControls"), a("html, .header-fixed").css(n), b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo || a(document.body)),
        ...
        _close: function() {
            ...
            b._removeClassFromMFP(c), b.fixedContentPos) {
                ...
                b.isIE7 ? a("body, html").css("overflow", "") : e.overflow = "", a("html, .header-fixed").css(e);
            }
