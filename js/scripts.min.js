...
$(function(){var b;mixitup(".portfolio_grid");$(".s_portfolio li").click(function(){$(".s_portfolio li").removeClass("active"),$(this).addClass("active")}),$(".popup_content").magnificPopup({type:"inline",midClick:!0,removalDelay:300,mainClass:"mfp-fade"}),$(".portfolio_item").each(function(t){$(this).find(".popup_content").attr("href","#work_"+t),$(this).find(".portfolio_descr").attr("id","work_"+t)}),$(".drawer-list a").click(function(){$(".click-close").click()}),$(".drawer-list, .menu").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),i=$(e).offset().top;$("body,html").animate({scrollTop:i},500)}),$("#header").headroom({offset:5,tolerance:5,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),$(".form_contacts").submit(function(){if(0==$("#g-recaptcha-response").val().length)return $(".robot-text").fadeIn(),!1;$(".contacts-submit").addClass("loading");var t=$(this);return $.ajax({type:"POST",url:"https://usebasin.com/f/2c02fde4c819",data:t.serialize()}).done(function(){$(t).find(".success").css("display","flex").hide().fadeIn(),setTimeout(function(){$(t).find(".success").fadeOut(),t.trigger("reset"),$(".contacts-submit").removeClass("loading")},2200),$(".robot-text").fadeOut(),grecaptcha.reset()}),!1}),(b=jQuery).fn.visible=function(t,e,i){var o=b(this).eq(0),n=o.get(0),s=b(window),a=s.scrollTop(),r=a+s.height(),c=s.scrollLeft(),l=c+s.width(),f=o.offset().top,d=f+o.height(),u=o.offset().left,p=u+o.width(),h=!0===t?d:f,$=!0===t?f:d,m=!0===t?p:u,v=!0===t?u:p,g=!0!==e||n.offsetWidth*n.offsetHeight;return"both"===(i=i||"both")?!!g&&$<=r&&a<=h&&v<=l&&c<=m:"vertical"===i?!!g&&$<=r&&a<=h:"horizontal"===i?!!g&&v<=l&&c<=m:void 0},jQuery(window).scroll(function(t){jQuery(".animate").each(function(t,e){(e=jQuery(e)).visible(!0)&&e.addClass("start")})})});