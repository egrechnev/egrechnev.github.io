...
$(function(){mixitup(".portfolio_grid");$(".s_portfolio li").click(function(){$(".s_portfolio li").removeClass("active"),$(this).addClass("active")}),$(".popup_content, .game").magnificPopup({type:"inline",midClick:!0,removalDelay:300,mainClass:"mfp-fade"}),$(".portfolio_item").each(function(i){$(this).find(".popup_content").attr("href","#work_"+i),$(this).find(".portfolio_descr").attr("id","work_"+i)}),$(".drawer-list a").click(function(){$(".click-close").click()}),$(".drawer-list a, .menu a").click(function(i){var t=this.hash.slice(0);if(t&&"#"!==!t[0]){i.preventDefault(),window.location.hash="";$(t).offset();$("html, body").animate({scrollTop:$(t).offset().top},500),history.pushState&&history.pushState({},null,window.location.pathname)}}),$("#header").headroom({offset:5,tolerance:5,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),$("#form_contacts").submit(function(){$(".contacts-submit").addClass("loading");var i=$(this);return $.ajax({type:"POST",url:"../mail.php",data:i.serialize()}).done(function(){$(i).find(".success").addClass("active").css("display","block").hide().fadeIn(),setTimeout(function(){$(i).find(".success").removeClass("active").fadeOut(),i.trigger("reset"),$(".contacts-submit").removeClass("loading")},2e3)}),!1})});